 ...
 */
function greenbacks_show_if_front_page( $cmb ) {
...
add_action( 'cmb2_admin_init', 'greenbacks_register_frontpage_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function greenbacks_register_frontpage_metabox() {
    $prefix = '_greenbacks_';
    ...
    $cmb_demo = new_cmb2_box( array(
        ...
        'show_on' => array( 'key' => 'page-template', 'value' => 'frontpage.php' ), // Make sure to change this based on site your working on greenbacks vs. greenbacks2
        'context'    => 'normal',
        'priority'   => 'high',
    ...
    $cmb_demo->add_field( array(
        'name' => __( 'Static Hero Image: Image', 'cmb2' ),
        'desc' => __( 'Upload an image or enter a URL.', 'cmb2' ),
        'id'   => $prefix . 'static_hero_image',
        'type' => 'file',
    ) );
