        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-holder">
                            <a href="http://knssandbox.com/berich2/wp-content/uploads/2017/01/Regis-University-Chapel-001.jpg" class="lightbox"  data-lightbox-gallery="gallery1">
                                <img src="http://knssandbox.com/berich2/wp-content/uploads/2017/01/Regis-University-Chapel-001.jpg" alt="">
                                <div class="project-overlay">
													<span class="link-holder">
														<i class="icon-eye"></i>
													</span>
